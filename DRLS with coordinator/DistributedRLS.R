...
matplot(Iterations,plotMSE,type="b",pch=16,main="Comparison Between Central Estimation and Coordinator's Estimation",xlab="Iterations",ylab="Central Estimation(Black) and Coordinator's Estimation(Red)in dB")
